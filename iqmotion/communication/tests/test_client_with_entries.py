...
from iqmotion.communication.tests.helpers import make_fake_message
...
class TestClientWithEntries():
    ...
    def test_client_jsons(self):
        dir_path = os.path.join(os.path.dirname(__file__), '../clients/')
    ...
    def test_not_supported_client_entry(self):
        ...
        assert "CLIENT ERROR: ClientWithEntries does not support this payload type\n" == err_str
